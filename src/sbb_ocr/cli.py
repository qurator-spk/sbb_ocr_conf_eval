...
@click.option('-wwr', '--weight-word-range', nargs=2, type=(int, int), help='Word count (word weight) range for filtering data, specify <NUMBER_START> <NUMBER_END> (optional)')
@click.option('-wtr', '--weight-textline-range', nargs=2, type=(int, int), help='Textline count (textline weight) range for filtering data, specify <NUMBER_START> <NUMBER_END> (optional)')

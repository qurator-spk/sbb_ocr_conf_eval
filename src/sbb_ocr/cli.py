...
@click.option('-botw', '--bottom-ppns-word', type=int, help='Choose a number of bottom PPNs or PPN_PAGEs with mean word nscores between 0.0 and 0.05, specify <NUMBER_OF> (optional)')
@click.option('-topt', '--top-ppns-textline', type=int, help='Choose a number of top PPNs or PPN_PAGEs with mean textline scores between 0.95 and 1.0, specify <NUMBER_OF> (optional)')
@click.option('-bott', '--bottom-ppns-textline', type=int, help='Choose a number of bottom PPNs or PPN_PAGEs with mean textline scores between 0.0 and 0.05, specify <NUMBER_OF> (optional)')
...
@click.option('-wcr', '--mean-word-confs-range', nargs=2, type=(float, float), help='Choose a mean word confidence score range for filtering data, specify <MEAN_WORD_START MEAN_WORD_END> (optional)')
@click.option('-tcr', '--mean-textline-confs-range', nargs=2, type=(float, float), help='Choose a mean textline confidence score range for filtering data, specify <MEAN_TEXTLINE_START MEAN_TEXTLINE_END> (optional)')
@click.option('-ge', '--show-genre-evaluation', 'show_genre_evaluation', is_flag=True, default=False, help="Evaluate the genres in the CSV_FILES (optional)")
@click.option('-o', '--output', 'output', type=click.File('w'), help='Save the results and the description of the results to an OUTPUT_CSV_FILE (optional)')
@click.option('-de', '--show-dates-evaluation', 'show_dates_evaluation', is_flag=True, default=False, help="Evaluate the publication dates in the CSV_FILES (optional)")
@click.option('-r', '--show-results', 'show_results', is_flag=True, default=False, help="Show the light version of the results [ppn, ppn_page/num_pages, mean_word, weight_word, weight_textline, originInfo-publication0_dateIssued, genre-aad] (optional)")
@click.option('-bmw', '--best-mean-word-confs', type=int, help='Choose a number of PPNs or PPN_PAGEs with the best mean word scores, specify <NUMBER_OF> (optional)')
@click.option('-wmw', '--worst-mean-word-confs', type=int, help='Choose a number of PPNs or PPN_PAGEs with the worst mean word scores, specify <NUMBER_OF> (optional)')
@click.option('-bmt', '--best-mean-textline-confs', type=int, help='Choose a number of PPNs or PPN_PAGEs with the best mean textline scores, specify <NUMBER_OF> (optional)')
@click.option('-wmt', '--worst-mean-textline-confs', type=int, help='Choose a number of PPNs or PPN_PAGEs with the worst mean textline scores, specify <NUMBER_OF> (optional)')
...
@click.option('-ww', '--search-weight-word', 'search_weight_word', type=int, help='Filter the data for a specific number of words (word weight), specify <NUMBER_OF> (optional)')
@click.option('-wt', '--search-weight-textline', 'search_weight_textline', type=int, help='Filter the data for a specific number of textlines (textline weight), specify <NUMBER_OF> (optional)')
...
@click.option('-npr', '--number-of-pages-range', nargs=2, type=(int, int), help='Choose a number of PPN_PAGEs range for filtering data, specify <NUMBER_START> <NUMBER_END> (optional)')
@click.option('-ne', '--number-of-pages-evaluation', 'show_number_of_pages_evaluation', is_flag=True, default=False, help="Evaluate the page counts in the CSV_FILES (optional)")
@click.option('-le', '--show-languages-evaluation', 'show_languages_evaluation', is_flag=True, default=False, help="Evaluate the languages in the CSV_FILES (optional)")
...
def plot_cli(
    ...
    number_of_pages_range,
    show_number_of_pages_evaluation,
    show_languages_evaluation
):
    """
    ...
    plot_everything(
        ...
        number_of_pages_range=number_of_pages_range,
        show_number_of_pages_evaluation=show_number_of_pages_evaluation,
        show_languages_evaluation=show_languages_evaluation
    )
